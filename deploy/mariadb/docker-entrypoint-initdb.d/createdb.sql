...
CREATE DATABASE IF NOT EXISTS `bookr` COLLATE 'utf8_general_ci' ;
GRANT ALL ON `bookr`.* TO 'default'@'%' ;

CREATE DATABASE IF NOT EXISTS `bookr_testing` COLLATE 'utf8_general_ci' ;
GRANT ALL ON `bookr_testing`.* TO 'default'@'%' ;
